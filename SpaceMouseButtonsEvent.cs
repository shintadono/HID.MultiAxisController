...
{
	/// <summary>
	/// Contains a button event record of a SpaceMouse/SpaceNavigator/SpaceExplorer/... raw input event.
	/// </summary>
	...
	public struct SpaceMouseButtonsEvent
	{
		/// <summary>
		...
		/// <summary>
		/// The actual SpaceMouse buttons event data. Multiple more of this dataset may follow,
		/// depending on <see cref="SpaceMouseEventHeader.dwCount">SpaceMouseButtonsEvent.Header.dwCount</see>.
		/// </summary>
		public SpaceMouseButtonsEventData Data;
	}
}
